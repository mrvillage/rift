            ...
            if nation.color != "Beige" and target[2] == 0:
                if target[3] == "[]":
                    ...
                    for id in json.loads(target[4]):
                        ...
                        embed = rift.get_embed_author_guild(channel.guild, f"[Nation Page](https://politicsandwar.com/nation/id={nation.id} \"https://politicsandwar.com/nation/id={nation.id}\")", timestamp=bot.nations_update, footer="Data collected at", fields=[
