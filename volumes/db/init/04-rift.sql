...
COMMENT ON COLUMN "target_presets"."count" IS 'flags that show what can contain';

COMMENT ON COLUMN "target_presets"."condition" IS 'condition to apply by default when using the preset';

COMMENT ON COLUMN "target_presets"."use_condition" IS 'condition to determine who can use the preset';
